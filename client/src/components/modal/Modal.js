    ...
    <Portal>
      {(modal.open || active) && (
        <div
          ...
          className={`fixed w-full h-full z-50 flex items-center justify-center bg-black bg-opacity-50 top-0 left-0 transform transition-transform duration-200 backdrop-filter backdrop-blur-sm ${
